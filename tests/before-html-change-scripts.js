const tickTackToe = () => {
  ...
  class Board {
    ...
    showStart() {
      console.log("SCREEN before START:\n", this.currentScreen);
      if (this.currentScreen) {
        console.log("RESET: START:\n", this.currentScreen);
        this.currentScreen.style.display = "none";
        this.screen.insertAdjacentHTML("afterend", this.startScreenHTML);
        this.currentScreen = this.screen.firstElementChild;
        return this.screen.innerHTML;
      } else {
        this.screen.innerHTML = this.startScreenHTML;
        this.currentScreen = this.screen.lastElementChild;
        return this.screen;
      }
    }

    showBoard() {
      console.log("SCREEN before BOARD:\n", this.currentScreen);
      this.currentScreen.style.display = "none";
      console.log("all screen html BEFORE INSERT:\n", this.screen);
      this.screen.insertAdjacentHTML("afterend", this.boardScreenHTML);
      console.log("all screen html AFTER INSERT:\n", this.screen);
      this.currentScreen = this.screen.lastElementChild;
      return this.screen;
    }
    ...
    constructor({  } = {}) {
      ...
      this.screen = document.querySelector("#board");
      this.startScreenHTML = `<div class="screen screen-start" id="start">
        <header>
          <h1>Tic Tac Toe</h1>
          <a href="#" class="button">Start game</a>
        </header>
      </div>`;
      this.boardScreenHTML = `<div class="board" id="board">
        <header>
          <h1>Tic Tac Toe</h1>
          <ul>
  ...
  let board = new Board({});
  board.showStart();
  // const screenStart = board.showStart();
